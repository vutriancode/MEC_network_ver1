...
from rl.policy import EpsGreedyQPolicy,ProposePolicy
...
class Fuzzy_Controller():
    def __init__(self):
      self.rule=pd.read_excel("C:/Users/vutri/OneDrive/Desktop/15092020/code/data/rule2.xlsx",index_col=0).to_numpy()
    def fuzzy_member_function(self,a,b,c,d,value):
        if value<=a:
            return [1,0,0]
            ...
            return [0,0,1]
    def fuzzy_choose_action(self,observation):
        percent_action=[0,0,0,0,0]
        a=[]
        server=self.fuzzy_member_function(0.6,1,2.5,4,observation[9])
        bus1_time=self.fuzzy_member_function(0.5,1.2,2,2.5,observation[1])  
        bus2_time=self.fuzzy_member_function(0.5,1.2,2,2.5,observation[4])
        bus3_time=self.fuzzy_member_function(0.5,1.2,2,2.5,observation[7])
        deadline=self.fuzzy_member_function(1.2,1.4,2,2.5,observation[13])
...
class BusEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.i=0
        data900=pd.read_excel("C:/Users/vutri/OneDrive/Desktop/15092020/code/data/data9000.xlsx", index_col=0).to_numpy()
        data900=data900[:,13:15]
        data901=pd.read_excel("C:/Users/vutri/OneDrive/Desktop/15092020/code/data/data9001.xlsx", index_col=0).to_numpy()
        data901=data901[:,13:15]
        data902=pd.read_excel("C:/Users/vutri/OneDrive/Desktop/15092020/code/data/data9002.xlsx", index_col=0).to_numpy()
        data902=data902[:,13:15]
        self.data_bus={"900":data900,"901":data901,"902":data902}
        self.data=pd.read_csv("C:/Users/vutri/OneDrive/Desktop/a/data7/data_csv"+str(self.i)+".csv").to_numpy()
    ...
    def step(self,action):
        ...
        if action>0 and action<4:
            ...
            Rmi1=(10*np.log2(1+46/(np.power(self.observation[(action-1)*3],4)*100)))/8
